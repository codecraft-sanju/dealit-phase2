                  ...
                  <>
                    ...
                    <td className="px-4 md:px-6 py-3 md:py-4">
                      <div className="flex flex-col gap-1.5">
                        ...
                        {/* 3 Refund States: Processing, Failed, Refunded */}
                        {row.paymentStatus === 'refund_processing' && (
                          <span className="text-[8px] font-bold text-orange-400 bg-orange-500/10 border border-orange-500/20 px-2 py-1 rounded w-fit flex items-center gap-1">
                            <Clock className="w-2.5 h-2.5" /> Processing Refund
                          </span>
                        )}
                        {row.paymentStatus === 'refund_failed' && (
                          <span className="text-[8px] font-bold text-red-400 bg-red-500/10 border border-red-500/20 px-2 py-1 rounded w-fit flex items-center gap-1">
                            <AlertCircle className="w-2.5 h-2.5" /> Refund Failed
                          </span>
                        )}
                        {row.paymentStatus === 'refunded' && (
                          <span className="text-[8px] font-bold text-emerald-400 bg-emerald-500/10 border border-emerald-500/20 px-2 py-1 rounded w-fit flex items-center gap-1">
