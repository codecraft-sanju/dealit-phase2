...
const BottomNav = ({ user }) => {
  ...
  return (
    ...
    <div className="md:hidden fixed bottom-4 left-4 right-4 bg-white/95 backdrop-blur-2xl border border-gray-100/50 rounded-[2rem] z-50 shadow-[0_10px_40px_rgba(107,70,193,0.15)] overflow-hidden">
