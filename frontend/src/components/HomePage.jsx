...
import { 
  ...
  Tag, ShoppingBag, ShieldCheck, CheckCircle
} from 'lucide-react';
...
const HomePage = ({ user, setUser }) => {
     ...
     queryFn: async () => {
       ...
       if (res.data.success && res.data.data) {
         return {
           ...
           isNewUIEnabled: res.data.data.isNewUIEnabled ?? true,
           heroBannerImage: res.data.data.heroBannerImage || '/hero-banner3.png',
           howItWorksImage: res.data.data.howItWorksImage || '/how-it-works3.png'
         };
       }
       return { enabled: true, amount: 50, isNewUIEnabled: true, heroBannerImage: '/hero-banner3.png', howItWorksImage: '/how-it-works3.png' };
     },
     staleTime: 1000 * 60 * 5, 
   });
   ...
   return (
     <motion.div 
       ...
       className={`max-w-md mx-auto bg-[#faf9fc] md:max-w-7xl md:px-0 relative overflow-hidden ${bonusSettings.isNewUIEnabled ? 'min-h-[calc(100vh-130px)] pb-10' : 'min-h-[calc(100vh-130px)]'}`}
     >
       <Helmet>
       ...
       {bonusSettings.isNewUIEnabled ? (
         <>
           ...
           <motion.div variants={itemVariants} className="px-4 pt-1 pb-0 relative z-10">
       ...
       <style>{`
         ...
         /* Added to support new UI animations if any differ */
         @keyframes glare-new {
